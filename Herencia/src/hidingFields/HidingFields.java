...
public class HidingFields {
	public static void main(String[] args) {
		...
		Hijo hijo = new Hijo();
		System.out.println("hola"+hijo.atributoEntero);
		...
		padre = hijo;// el objeto hijo es referenciado por el tipo estático del
						// padre. POLIMORFISMO
		System.out.println("hola"+padre.atributoEntero);
		System.out.println(padre.atributo);// el del padre, porque el tipo
											// estático es del padre.
...
class Padre {
	public String atributo = "Del padre";
	public int atributoEntero = 1;
...
class Hijo extends Padre {
	public String atributo = "Del Hijo";// con el mismo nombre que el del padre. Está
									// oculto
	public int atributoEntero = 2;
